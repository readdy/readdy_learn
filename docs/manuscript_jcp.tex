...
\begin{figure}
    ...
    \caption{\label{fig:mapk}Application of reactive SINDy to the MAPK pathway system. \textbf{(a)}~The response curve of the MAPK cascade as a function of external stimulus given as a constant concentration $[\mathrm{S}]$. The activity is the long-time concentration of activated transcription factors $[\mathrm{TF*}]$. Dashed lines show the values of $[\mathrm{S}]$ at which concentration time series data was generated. \textbf{(b)}~Estimated rate coefficients of candidate reactions after application of reactive SINDy (regularized) to the time series data. LSQ estimation and the ground truth model for comparison.}
\end{figure}
...
\begin{figure}
    ...
    \caption{\label{fig:lv}Application of reactive SINDy to the Lotka-Volterra system with social friction. \textbf{(a)}~Concentration data as a function of time for predator and prey. \textbf{(b)}~Estimated rate coefficients of candidate reactions after application of reactive SINDy (regularized) to the time series data. LSQ estimation and the ground truth model for comparison.}
\end{figure}
...
\begin{table*}[h!]
    ...
    \begin{tabular}{rclcc}
        ...
        \multicolumn{3}{c}{Reaction} & rate & description \tabularnewline
        \midrule 
        $\mathrm{X} + \mathrm{X}$ & $\rightharpoonup$ & $\emptyset             $  & $k_{1} =0.1$ & social friction of prey\tabularnewline
        $\mathrm{Y} + \mathrm{Y}$ & $\rightharpoonup$ & $\emptyset             $  & $k_{2} =0.1$ & social friction of predator\tabularnewline
        $\mathrm{X}             $ & $\rightharpoonup$ & $\mathrm{X} + \mathrm{X}$ & $k_{3} =1  $ & prey growth\tabularnewline
        $\mathrm{X} + \mathrm{Y}$ & $\rightharpoonup$ & $\mathrm{Y} + \mathrm{Y}$ & $k_{4} =1  $ & predator eats prey\tabularnewline
        $\mathrm{Y}             $ & $\rightharpoonup$ & $\emptyset             $  & $k_{5} =1  $ & predator decays\tabularnewline
        $\mathrm{X} + \mathrm{Y}$ & $\rightharpoonup$ & $\mathrm{X} + \mathrm{X}$ & $k_{6} =0  $ & artificial reaction\tabularnewline
        $\mathrm{X}             $ & $\rightharpoonup$ & $\emptyset             $  & $k_{7} =0  $ & artificial reaction\tabularnewline
        $\mathrm{Y} + \mathrm{Y}$ & $\rightharpoonup$ & $\mathrm{Y}             $ & $k_{8} =0  $ & artificial reaction\tabularnewline
        $\mathrm{Y}             $ & $\rightharpoonup$ & $\mathrm{Y} + \mathrm{Y}$ & $k_{9} =0  $ & artificial reaction\tabularnewline
        $\mathrm{X} + \mathrm{X}$ & $\rightharpoonup$ & $\mathrm{X}             $ & $k_{10}=0  $ & artificial reaction\tabularnewline
        $\mathrm{X} + \mathrm{Y}$ & $\rightharpoonup$ & $\mathrm{X}             $ & $k_{11}=0  $ & artificial reaction\tabularnewline
        $\mathrm{X} + \mathrm{Y}$ & $\rightharpoonup$ & $\mathrm{Y}             $ & $k_{12}=0  $ & artificial reaction\tabularnewline
        $\mathrm{X} + \mathrm{X}$ & $\rightharpoonup$ & $\mathrm{Y}             $ & $k_{13}=0  $ & artificial reaction\tabularnewline
        $\mathrm{X}             $ & $\rightharpoonup$ & $\mathrm{Y}             $ & $k_{14}=0  $ & artificial reaction\tabularnewline
        $\mathrm{Y}             $ & $\rightharpoonup$ & $\mathrm{X}             $ & $k_{15}=0  $ & artificial reaction\tabularnewline
        $\mathrm{X}             $ & $\rightharpoonup$ & $\mathrm{Y} + \mathrm{Y}$ & $k_{16}=0  $ & artificial reaction\tabularnewline
        \bottomrule
