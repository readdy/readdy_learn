...
\begin{table*}[h!]
    ...
    \begin{tabular}{rclc}
        \toprule 
        \multicolumn{3}{c}{Reaction} & rate \tabularnewline
        \midrule 
        $\mathrm{S}        + \mathrm{MAPKKK}$  & $\rightharpoonup$  &  $\mathrm{S      } + \mathrm{MAPKKK*}$ & $k_{1} =1$ \tabularnewline
        $\mathrm{MAPKKK*}    \mathrm{      }$  & $\rightharpoonup$  &  $\mathrm{MAPKKK }                   $ & $k_{2} =1$ \tabularnewline
        $\mathrm{MAPKKK*}  + \mathrm{MAPKK }$  & $\rightharpoonup$  &  $\mathrm{MAPKKK*} + \mathrm{MAPKK* }$ & $k_{3} =1$ \tabularnewline
        $\mathrm{MAPKK*}     \mathrm{      }$  & $\rightharpoonup$  &  $\mathrm{MAPKK  }                   $ & $k_{4} =1$ \tabularnewline
        $\mathrm{MAPKK*}   + \mathrm{MAPK  }$  & $\rightharpoonup$  &  $\mathrm{MAPKK* } + \mathrm{MAPK*  }$ & $k_{5} =1$ \tabularnewline
        $\mathrm{MAPK*}      \mathrm{      }$  & $\rightharpoonup$  &  $\mathrm{MAPK   }                   $ & $k_{6} =1$ \tabularnewline
        $\mathrm{MAPK*}    + \mathrm{TF    }$  & $\rightharpoonup$  &  $\mathrm{MAPK*  } + \mathrm{TF*    }$ & $k_{7} =1$ \tabularnewline
        $\mathrm{TF*}        \mathrm{      }$  & $\rightharpoonup$  &  $\mathrm{TF     }                   $ & $k_{8} =1$ \tabularnewline
        $\mathrm{MAPKKK}   + \mathrm{MAPKK }$  & $\rightharpoonup$  &  $\mathrm{MAPKKK } + \mathrm{MAPKK* }$ & $k_{9} =0$ \tabularnewline
        $\mathrm{MAPKKK}   + \mathrm{MAPK  }$  & $\rightharpoonup$  &  $\mathrm{MAPK*  }                   $ & $k_{10}=0$ \tabularnewline
        $\mathrm{MAPKKK}   + \mathrm{TF    }$  & $\rightharpoonup$  &  $\mathrm{MAPKKK } + \mathrm{TF*    }$ & $k_{11}=0$ \tabularnewline
        $\mathrm{MAPKKK*}  + \mathrm{MAPK  }$  & $\rightharpoonup$  &  $\mathrm{MAPKKK*} + \mathrm{MAPK*  }$ & $k_{12}=0$ \tabularnewline
        $\mathrm{MAPKKK*}  + \mathrm{TF    }$  & $\rightharpoonup$  &  $\mathrm{MAPKKK*} + \mathrm{TF*    }$ & $k_{13}=0$ \tabularnewline
        $\mathrm{MAPKK}    + \mathrm{TF    }$  & $\rightharpoonup$  &  $\mathrm{MAPKK  } + \mathrm{TF*    }$ & $k_{14}=0$ \tabularnewline
        $\mathrm{MAPKK*}   + \mathrm{TF    }$  & $\rightharpoonup$  &  $\mathrm{MAPKK* } + \mathrm{TF*    }$ & $k_{15}=0$ \tabularnewline
        $\mathrm{MAPK}     + \mathrm{TF    }$  & $\rightharpoonup$  &  $\mathrm{MAPK   } + \mathrm{TF*    }$ & $k_{16}=0$ \tabularnewline
        $\mathrm{MAPKK}    + \mathrm{MAPK  }$  & $\rightharpoonup$  &  $\mathrm{MAPKK  } + \mathrm{MAPK*  }$ & $k_{17}=0$ \tabularnewline
        $\mathrm{MAPKKK}   + \mathrm{MAPKK*}$  & $\rightharpoonup$  &  $\mathrm{MAPKKK } + \mathrm{MAPKK  }$ & $k_{18}=0$ \tabularnewline
        $\mathrm{MAPKKK}   + \mathrm{MAPK* }$  & $\rightharpoonup$  &  $\mathrm{MAPKKK } + \mathrm{MAPK   }$ & $k_{19}=0$ \tabularnewline
        $\mathrm{MAPKKK}   + \mathrm{TF*   }$  & $\rightharpoonup$  &  $\mathrm{MAPKKK } + \mathrm{TF     }$ & $k_{20}=0$ \tabularnewline
        $\mathrm{MAPKKK*}  + \mathrm{MAPKK*}$  & $\rightharpoonup$  &  $\mathrm{MAPKKK*} + \mathrm{MAPKK  }$ & $k_{21}=0$ \tabularnewline
        $\mathrm{MAPKKK*}  + \mathrm{MAPK* }$  & $\rightharpoonup$  &  $\mathrm{MAPKKK*} + \mathrm{MAPK   }$ & $k_{22}=0$ \tabularnewline
        $\mathrm{MAPKKK*}  + \mathrm{TF*   }$  & $\rightharpoonup$  &  $\mathrm{MAPKKK*} + \mathrm{TF     }$ & $k_{23}=0$ \tabularnewline
        $\mathrm{MAPKK}    + \mathrm{MAPK* }$  & $\rightharpoonup$  &  $\mathrm{MAPKK  } + \mathrm{MAPK   }$ & $k_{24}=0$ \tabularnewline
        $\mathrm{MAPKK}    + \mathrm{TF*   }$  & $\rightharpoonup$  &  $\mathrm{MAPKK  } + \mathrm{TF     }$ & $k_{25}=0$ \tabularnewline
        $\mathrm{MAPKK*}   + \mathrm{MAPK* }$  & $\rightharpoonup$  &  $\mathrm{MAPKK* } + \mathrm{MAPK   }$ & $k_{26}=0$ \tabularnewline
        $\mathrm{MAPKK*}   + \mathrm{TF*   }$  & $\rightharpoonup$  &  $\mathrm{MAPKK* } + \mathrm{TF     }$ & $k_{27}=0$ \tabularnewline
        $\mathrm{MAPK}     + \mathrm{TF*   }$  & $\rightharpoonup$  &  $\mathrm{MAPK   } + \mathrm{TF     }$ & $k_{28}=0$ \tabularnewline
        $\mathrm{MAPK*}    + \mathrm{TF*   }$  & $\rightharpoonup$  &  $\mathrm{MAPK*  } + \mathrm{TF     }$ & $k_{29}=0$ \tabularnewline
        \bottomrule
...
\begin{table*}[h!]
    ...
    \begin{tabular}{rclc}
        ...
        \multicolumn{3}{c}{Reaction} & rate \tabularnewline
        \midrule 
        $\mathrm{X} + \mathrm{X}$ & $\rightharpoonup$ & $\emptyset             $ & $k_{1} =0.1$ \tabularnewline
        $\mathrm{Y} + \mathrm{Y}$ & $\rightharpoonup$ & $\emptyset             $ & $k_{2} =0.1$ \tabularnewline
        $\mathrm{X}             $ & $\rightharpoonup$ & $\mathrm{X} + \mathrm{X}$ & $k_{3} =1  $ \tabularnewline
        $\mathrm{X} + \mathrm{Y}$ & $\rightharpoonup$ & $\mathrm{Y} + \mathrm{Y}$ & $k_{4} =1  $ \tabularnewline
        $\mathrm{Y}             $ & $\rightharpoonup$ & $\emptyset             $ & $k_{5} =1  $ \tabularnewline
        $\mathrm{X} + \mathrm{Y}$ & $\rightharpoonup$ & $\mathrm{X} + \mathrm{X}$ & $k_{6} =0  $ \tabularnewline
        $\mathrm{X}             $ & $\rightharpoonup$ & $\emptyset             $ & $k_{7} =0  $ \tabularnewline
        $\mathrm{Y} + \mathrm{Y}$ & $\rightharpoonup$ & $\mathrm{Y}             $ & $k_{8} =0  $ \tabularnewline
        $\mathrm{Y}             $ & $\rightharpoonup$ & $\mathrm{Y} + \mathrm{Y}$ & $k_{9} =0  $ \tabularnewline
        $\mathrm{X} + \mathrm{X}$ & $\rightharpoonup$ & $\mathrm{X}             $ & $k_{10}=0  $ \tabularnewline
        $\mathrm{X} + \mathrm{Y}$ & $\rightharpoonup$ & $\mathrm{X}             $ & $k_{11}=0  $ \tabularnewline
        $\mathrm{X} + \mathrm{Y}$ & $\rightharpoonup$ & $\mathrm{Y}             $ & $k_{12}=0  $ \tabularnewline
        $\mathrm{X} + \mathrm{X}$ & $\rightharpoonup$ & $\mathrm{Y}             $ & $k_{13}=0  $ \tabularnewline
        $\mathrm{X}             $ & $\rightharpoonup$ & $\mathrm{Y}             $ & $k_{14}=0  $ \tabularnewline
        $\mathrm{Y}             $ & $\rightharpoonup$ & $\mathrm{X}             $ & $k_{15}=0  $ \tabularnewline
        $\mathrm{X}             $ & $\rightharpoonup$ & $\mathrm{Y} + \mathrm{Y}$ & $k_{16}=0  $ \tabularnewline
        \bottomrule
