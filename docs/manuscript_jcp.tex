...
\documentclass[english,osajnl,jcp,preprint,groupedaddress,noshowpacs,showkeys,longbibliography,noeprint,nofootinbib,bibtex,ruled,vlined,english,natural,table,usenames,dvipsnames,a4paper]{revtex4-1}
...
\begin{figure}
\centering \includegraphics[width=\singlecolumnwidth]{figures_tex/scheme}
...
\begin{figure}
\centering\includegraphics[width=\singlecolumnwidth]{figures_tex/trajectories_lsq}\caption{\label{fig:case-1-lsq}Concentration time series generated from integrating
...
\end{figure}
\begin{figure}
\centering \includegraphics[width=0.82\doublecolumnwidth]{figures_tex/sparsity_pattern}
...
\begin{figure}
\centering \includegraphics[width=\singlecolumnwidth]{figures_tex/case2}
...
\begin{figure}
\centering \includegraphics[width=\singlecolumnwidth]{figures_tex/case3}
...
\centering\includegraphics[width=\singlecolumnwidth]{figures_tex/case1_cutoff}\caption{\label{fig:reaction-rates-sorted}Reaction rates sorted by their magnitude
